...
| Channel | Version | Status | Since | Notes |
|---|---|---|---|---|
| Play Store (production) | none yet | **production access applied — in review** | 2026-07-28 (applied 11:47) | closed-test gate **CLEARED** (12 testers × 14 days). The "Apply for access to production" form was submitted 2026-07-28; Play Console shows "We have your application for production access", reviewed in **seven days or less**, outcome emailed to the account owner. No production release/binary yet — a production track release can only be created once access is granted |
