...
| Channel | Version | Status | Since | Notes |
|---|---|---|---|---|
| Play Store (production) | none yet | **production access GRANTED — track inactive, no release yet** | 2026-08-03 (announced) | the 2026-07-28 access application was approved; Play Console dashboard now shows the Production track as "Inactive" (usable but empty). Next step: create the first production release — promote closed-testing 1.0.0 (4) (repo matches at versionCode 4), select production countries/regions, and roll out; the first production release goes through app review |
