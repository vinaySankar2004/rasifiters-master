...
| TestFlight — external ("Beta Testers") | 1.4.0 (53) | Testing | 2026-07-15 (announced) | 1.4.0 train CLOSED by App Store approval of 53. **1.4.1 (54) deliberately SKIPS external beta** (it's the App Store candidate — no point beta-reviewing it). Next external build = **1.4.2 (55)**, uploading for one-time Beta App Review 2026-07-16 (announced); flips this cell when the user confirms it's testing |
| TestFlight — internal ("Internal") | 1.4.1 (54) | Uploaded/Testing | 2026-07-16 (announced) | 1.4.1 (54) is the **App Store candidate** (user submitting as the next public release; internal-only on TestFlight). External testing continues on the ahead-train (1.4.2 (55)) |
...
|---|---|---|---|---|---|
| 2026-07-16 | iOS | 1.4.2 (55) | TestFlight — external ("Beta Testers") | preparing upload + beta review | **Uploading (announced)** — the ahead-train build; external testers move to it via its one-time Beta App Review. Same code as 1.4.1 (54) at this point (member-analytics 0.4.0 D-C7) |
