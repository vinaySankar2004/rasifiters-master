...
| `apple-health` | 0.1.0 | 🏗️ | `ios` | `ios` (`HealthKitService.swift`, `HealthKitWorkoutTypeMap.swift`, `ProgramContext+HealthKit.swift`, `AppleHealthSettingsView.swift`; provenance: PR #4) | [apple-health/SPEC.md](apple-health/SPEC.md) |
