...
| `apple-health` | 0.1.0 | 🏗️ | `ios` | `ios-mobile` PR #4 (`HealthKitService.swift`, `HealthKitWorkoutTypeMap.swift`, `ProgramContext+HealthKit.swift`, `AppleHealthSettingsView.swift`) | [apple-health/SPEC.md](apple-health/SPEC.md) |
