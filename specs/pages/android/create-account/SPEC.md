...
- **Deviation A-6 (wizard, v0.3.0):** the single scrolling form is now a **`HorizontalPager` wizard** with a
...
- **Deviation A-7 (social 2-step branch, v0.3.0):** when `ProgramContext.pendingSocial` is non-null (a brand-new
